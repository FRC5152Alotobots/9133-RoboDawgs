...
@Autonomous(name = "AutoTFoDRedA-SQ" , group = "TFOD RED")
//@Disabled
public class TfodSQ_RED extends LinearOpMode {
...
DmapAutoRed ahw = new DmapAutoRed(); 
            ...
            while (opModeIsActive()) {
                ...
                if (runtime.seconds() > 5){
                    telemetry.addData("FAILSAFE ACTIVATED" , "This happens if the marker is in a position that the camera cannot see.");
                        ...
                        telemetry.addData("Running class:" , "RedAHighSQ");
                        telemetry.update();
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                      ...
                      for (Recognition recognition : updatedRecognitions) {
                        ...
                        if (dtc == false){
                        //low pos
                        if (dpos < 300 && dpos > 100){
                        telemetry.addData("2 OR 5 DICE ROLL" , "(RIGHT)");
                        telemetry.addData("Running class:" , "RedAlowSQ");
                        telemetry.update();
                        ...
                        if (dpos < 100  && dpos > 0){
                        telemetry.addData("3 OR 6 DICE ROLL" , "(MIDDLE)");
                        telemetry.addData("Running class:" , "RedAmidSQ");
                        telemetry.update();
