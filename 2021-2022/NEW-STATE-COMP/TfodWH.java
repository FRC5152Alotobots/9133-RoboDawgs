...
@Autonomous(name = "AutoTFoDBlueB-WH" , group = "TFOD BLUE")
//@Disabled
public class TfodWH extends LinearOpMode {
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                      ...
                      for (Recognition recognition : updatedRecognitions) {
                        ...
                        telemetry.addData("Running class:" , "BlueBlowWH");
                        telemetry.update();
                        ...
                        telemetry.addData("Running class:" , "BlueBmidWH");
                        telemetry.update();
