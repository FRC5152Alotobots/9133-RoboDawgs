...
public class BasicMode2P extends OpMode
{
   ...
   // Declare conected devices (Motors, Servos, etc.)
    ...
    private DcMotor duckL = null;
    private DcMotor duckR = null;
...
//  ↓ Remove to activate
    ...
    duckR = hardwareMap.get(DcMotor.class, "duckR");
    ...
    led = hardwareMap.get(RevBlinkinLedDriver.class , "led");
      ...
      duckL.setDirection(DcMotor.Direction.FORWARD);
      duckR.setDirection(DcMotor.Direction.FORWARD);
